...
<div class="jumbotron">
    ...
    <label for="classe">Nom du groupe :  </label> <br>
    <input type="text" id="classe" name="classe" class="form-control"required pattern="INFO[1-3]{1}-[A-E]{1}"
     ...
     <label for="classe1">Nouveau nom du groupe :  </label> <br>
...
if (isset($_POST["confirmation"]))
{
    $nom=$_POST['classe'];
    $nom1=$_POST['classe1'];
    $req="UPDATE  `etudiant` set Classe='$nom1' WHERE Classe='$nom'";
    $resultat=mysqli_query($conn,$req);
    if ($resultat){
        echo " <font color='green'> modification du groupe reussite";
    }
    else{
